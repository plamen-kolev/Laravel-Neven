<div class="col-sm-12 footer">
    <div class="col-sm-12 footer_flowers">
        ...
        <div class="col-sm-2 hidden_flower">
            <img src='{{asset("images/footer/neven-right.jpg")}}' alt="Side image above the footer"/>
        </div>
        <div class="col-sm-1"></div>
    ...
    <div class="wrapper">
        ...
        <div class="col-sm-3 ">
            <p>{{ trans('text.find_us_on')}}</p>
                ...
                <a class="soc_icons" href=""><img alt="{{trans('text.facebook_icon_alt')}}" src="{{ asset('images/loading.gif') }}" class="b-lazy" data-src="{{asset('images/footer/facebook-icon.svg')}}" /></a>
        ...
        <div class="icons_and_trade">
            ...
            <img src="{{ asset('images/loading.gif') }}" class="b-lazy" data-src="{{asset('images/footer/visa_icon.png')}}" alt="Visa icon"/>
            <img src="{{ asset('images/loading.gif') }}" class="b-lazy" data-src="{{asset('images/footer/mastercard_icon.png')}}" alt="Mastercard icon"/>
            <img src="{{ asset('images/loading.gif') }}" class="b-lazy" data-src="{{asset('images/footer/amex_icon.png')}}" alt="American express icon"/>
            <img src="{{ asset('images/loading.gif') }}" class="b-lazy" data-src="{{asset('images/footer/paypal_icon.png')}}" alt="Paypal icon"/>
        </div>
