...
<div class="col-md-12 create_page">
    ...
    {!! Form::model($product, array('route' => array('product.update', $product->slug) , 'method' => 'PUT', 'files' => true)  ) !!}
...
<hr>
        ...
        <div class="col-md-12">
            {{ Form::label('related_products[]', 'Related products (control+click to assign)') }}
        ...
        <div class="col-md-12">
            {!! Form::submit('Update product', array('class' => 'generic_submit') )!!}
        </div>
