    ...
    <div class="wrapper">
        ...
        <div class="col-md-6">
            ...
            <form class="generic_form" role="form" method="POST" action="{!! route('auth.login') !!}">
                ...
                <input class="generic_input" type="email" id="login_email_field" placeholder="{{trans('text.email_address')}}" name="email" value="{{ old('email') }}"/>

                <input class="generic_input"  id="password" type="password" placeholder="{{trans('text.password')}}"  name="password"/>
