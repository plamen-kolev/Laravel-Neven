...
{
    public $errors = '';
    protected $fillable = array('featured', 'title_en', 'title_nb', 'description_en', 'benefits_en', 'benefits_nb' , 'tips_en','tips_nb','description_nb', 'in_stock', 'slug', 'thumbnail', 'hover_thumbnail', 'tips', 'benefits', 'tags', 'hidden_tags', 'category_id');
